...
namespace ICR.Infrastructure.Migrations
{
    ...
    [Migration("20260601143326_AddAddressDiscriminator")]
    partial class AddAddressDiscriminator
    {
        /// <inheritdoc />
                    ...
                    b.OwnsOne("ICR.Domain.Model.Address", "Address", b1 =>
                        {
                            ...
                            b1.Property<bool>("_addressExists")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("boolean")
                                .HasDefaultValue(false)
                                .HasColumnName("AddressExists");
                            ...
                            b1.OwnsOne("ICR.Domain.Model.Country", "Country", b2 =>
                                {
                                    ...
                                    b2.Property<bool>("_countryExists")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("boolean")
                                        .HasDefaultValue(false)
                                        .HasColumnName("CountryExists");
